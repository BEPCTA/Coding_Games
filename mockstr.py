...
def _unmockstr(x):
    """
    Secret function to convert mockstr back to str; 
...
class mockstr(str):
    ...
    def _c(self):
        """
        Secret method to convert to str,
        incrementing num_comparisons by len(self).
        """
    ...
    def _a(self):
        """
        Secret method to convert to str, 
        incrementing accesses by len(self).
        """
    ...
    def reset(verbose=True):
        """
        Reset counts to zero, and optionally, 
        before resetting, print the counts.
        """
        if verbose:
